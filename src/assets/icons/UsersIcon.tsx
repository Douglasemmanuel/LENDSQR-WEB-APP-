...
const Users = ({
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M4.8 6.4a2.8 2.8 0 1 0 0-5.6 2.8 2.8 0 0 0 0 5.6Zm1.92.8h-.207a3.938 3.938 0 0 1-1.713.4c-.615 0-1.19-.15-1.712-.4H2.88A2.88 2.88 0 0 0 0 10.08v.72A1.2 1.2 0 0 0 1.2 12h7.2a1.2 1.2 0 0 0 1.2-1.2v-.72A2.88 2.88 0 0 0 6.72 7.2Z"
    />
  </svg>
);
