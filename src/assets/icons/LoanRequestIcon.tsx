const LoanRequest = ({ size = 24, color = "currentColor", ...props }) => (
  <svg
  ...
  >
    ...
    <g fill="currentColor" opacity={0.4}>
      <path d="M7.75 1.875h2.5l.926-1.39a.312.312 0 0 0-.26-.485H7.085a.313.313 0 0 0-.26.486l.925 1.389Zm2.5.625h-2.5C3.797 4.754 4.002 7.747 4.002 8.125 4.002 9.16 4.96 10 6.144 10h5.713c1.183 0 2.142-.84 2.142-1.875 0-.371.182-3.384-3.749-5.625Z" />
